...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    function initializeZoom() {
        ...
        kpitrackingImage.addEventListener('contextmenu', e => e.preventDefault());
        ...
        kpitrackingImage.addEventListener('click', function(e) {
            ...
            if (kpitrackingImage.classList.contains('zoomed')) {
                // Zoom out
                ...
                const width = kpitrackingImage.clientWidth;
                const height = kpitrackingImage.clientHeight;
                ...
                requestAnimationFrame(() => {
                    const scaleX = kpitrackingImage.scrollWidth / width;
                    const scaleY = kpitrackingImage.scrollHeight / height;
        ...
        kpitrackingImage.addEventListener('touchstart', function(e) {
            if (kpitrackingImage.classList.contains('zoomed')) {
                isDragging = true;
