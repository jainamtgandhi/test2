...
document.addEventListener('DOMContentLoaded', function() {
    ...
    campaignexecutionImage.addEventListener('click', function(e) {
        ...
        if (isZoomed) {
            ...
            const rect = campaignexecutionImage.getBoundingClientRect();
            const clickX = e.clientX - rect.left;
            const clickY = e.clientY - rect.top;
            
            const scaleX = campaignexecutionImage.naturalWidth / rect.width;
            const scaleY = campaignexecutionImage.naturalHeight / rect.height;
