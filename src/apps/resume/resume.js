...
async function handleSaveResume() {
    ...
    try {
        ...
        if (data && data.resume && data.resume.pdf) {
            ...
            console.error('PDF path not found in info.json');
        }
    } catch (error) {
