...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    console.log('Found cards:', { socialLinksCard, skillsCard, softwareCard });
    ...
    console.log('Found card headers:', cardHeaders.length);
    
    cardHeaders.forEach(header => {
        header.addEventListener('click', function() {
            console.log('Card header clicked:', this);
...
function expandCard(card) {
    ...
    if (arrow) {
        ...
        console.log('Updated arrow src:', arrow.src);
    }
    console.log('Card classes after expand:', card.className);
}

function toggleCard(card) {
    if (!card) return;
    console.log('Toggling card:', card.id);
    card.classList.toggle('collapsed');
    const isCollapsed = card.classList.contains('collapsed');
    console.log('Is collapsed after toggle:', isCollapsed);
    const arrow = card.querySelector('.left-panel__card__header__img');
    if (arrow) {
        if (card.classList.contains('left-panel__card--social')) {
