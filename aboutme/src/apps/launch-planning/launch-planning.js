...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!launchplanningImage || !appRoot) {
    ...
    launchplanningImage.addEventListener('click', function(e) {
        ...
        if (isZoomed) {
            ...
            const rect = launchplanningImage.getBoundingClientRect();
            const clickX = e.clientX - rect.left;
            const clickY = e.clientY - rect.top;
            
            const scaleX = launchplanningImage.naturalWidth / rect.width;
            const scaleY = launchplanningImage.naturalHeight / rect.height;
